...
signal enter_free()
signal refresh_all_battle_data()
...
signal add_interrupt_selection(temp_id: int)
signal remove_interrupt_selection(temp_id : int)
signal interrupt_cards_ready(matched_cards)
